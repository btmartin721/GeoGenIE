...
\begin{titlepage}
\centering
\includegraphics[width=0.5\textwidth]{img/geogenie_logo.png}
\vfill
\vspace{0.5in}
{\Huge\bfseries GeoGenIE: Geographic Genetic Inference Engine\par}
\vspace{0.25in}
{\Large\bfseries Geolocation predicting from SNPs using deep learning\par}
\vspace{0.3in}
{\Large Drs. Bradley T. Martin, Tyler K. Chafin, Zach D. Zbinden, Marlis R. Douglas, and Michael E. Douglas\par}
\vspace{0.5in}
{\Large Version: 1.0.4\par}
\vspace{0.25in}
{\Large 2025-04-10}
\end{titlepage}
