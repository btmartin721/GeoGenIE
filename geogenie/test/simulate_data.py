...
def simulate_vcf_file(
    ...
    # Example: Print the number of mutations
    print("Number of mutations:", mutated_ts.num_mutations)

    with open("data/simulated_data.vcf", "w") as vcf_file:
        mutated_ts.write_vcf(vcf_file, ploidy=2)
...
tree_sequence = simulate_vcf_file(
    mutation_rate=1e-8,
    n_pops=4,
    num_loci=436,
    num_samples=200,
